...
public:
    ...
    static constexpr uint32_t kInitSentinel = 0x00C0DE, kDoneSentinel = 0x00D0E0;
    static constexpr uint32_t kBlockAddr = 0x500;   // Y:$500..$533, where the kernel reads the parameter block
